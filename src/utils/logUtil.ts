...
export const printInfo = function (
  tip: string = 'Danmaku Hub',
  link: string = 'https://github.com/qinant/danmaku-hub',
  color: string = '#fe2c55'
) {
  console.log(
    `%c ${tip} %c ${link}`,
...
export const printBrand = function () {
  console.log('%cDanmaku Hub', 'color: #00faf0; font-size: 20px; font-weight: bold;');
};

export const CLog = new Logger({ prefix: 'danmaku-hub' });
